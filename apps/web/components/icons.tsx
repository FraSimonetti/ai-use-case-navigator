// Inline SVG icons to replace emoji throughout the app
// Each icon is 16x16 by default, accepts className for sizing
...
export function ClipboardListIcon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function BarChart3Icon({ className = 'w-4 h-4' }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
